# Generated by Django 2.2.9 on 2022-02-07 19:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(default='-пусто-', max_length=400)),
                ('start_at', models.DateTimeField(auto_now_add=True, verbose_name='event date')),
